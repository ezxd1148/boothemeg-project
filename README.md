...
<div align="center">
<h1 align="center" style="color: blue, font-size: 28px, margin: 10px 0;">Description itu ini</h1>
<p align="center" style="font-size: 18px; margin: 10px 0;">Sub description ini itu.</p>
